...
{/* Use Cases  */}
    ...
    <div className="py-12 bg-gradient-to-br from-indigo-100 to-indigo-400 h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center items-center">
        <div className="lg:text-center">
          ...
          <p className="py-5 mt-4 max-w-2xl font-bold text-xl text-gray-800 lg:mx-auto flex justify-center items-center">
           Create your own crypotokens. Transfer or airdrop SPL-tokens to thousands of addresses. No Code. Within seconds.
          </p>
          <div className="mt-5 flex lg:mt-0 lg:ml-4"></div>
          <span className="py-5 hidden sm:block">
          <button
